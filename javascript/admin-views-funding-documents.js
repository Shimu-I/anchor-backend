document.addEventListener('DOMContentLoaded', function () {
    loadFundingDocuments();
});

async function loadFundingDocuments() {
    ...
    if (!postId) {
        container.innerHTML = `
            <div class="empty-state">
                ...
                <a href="admin-fundraisers.html" class="btn btn-approve">Go Back</a>
            </div>
        `;
        return;
    }
    ...
    if (pageTitle) {
        pageTitle.textContent = `Fundraiser #${postId} - Documents`;
    }
    ...
    try {
        ...
        if (data.success && data.documents && data.documents.length > 0) {
            ...
            container.innerHTML = `
                <div class="empty-state">
                    ...
                    <p>This fundraiser has no documents yet.</p>
                    <a href="admin-fundraisers.html" class="btn btn-approve">Go Back</a>
                </div>
            `;
        }
        ...
        container.innerHTML = `
            <div class="empty-state">
                ...
                <p>${error.message}</p>
                <button class="btn btn-approve" onclick="loadFundingDocuments()">Retry</button>
            </div>
        `;
    }
}
    ...
    return `
        <div class="request-item">
            ...
            <div class="request-details">
                <span class="detail-item"><strong>Type:</strong> ${doc.doc_type || 'Document'}</span>
